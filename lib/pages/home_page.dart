            ...
            return SingleChildScrollView(
              child:Column(
                children: <Widget>[
                  ...
                  FloorConten(floorGoodsList:floor1),
                  FloorTitle(pictureAddress:floor2Title),
                  FloorConten(floorGoodsList:floor2),
                  FloorTitle(pictureAddress:floor3Title),
                  FloorConten(floorGoodsList:floor3),
                ],
...
// 楼层商品列表
class FloorConten extends StatelessWidget {
  final List floorGoodsList;
  FloorConten({this.floorGoodsList});
  @override
  Widget build(BuildContext context) {
    return Container(
      child:Column(
